...
class TestBest extends StatefulWidget {
  const TestBest({Key? key}) : super(key: key);

  @override
  State<TestBest> createState() => _TestBestState();
}

class _TestBestState extends State<TestBest> with TickerProviderStateMixin {
  ...
  Widget CercleDeSigne(context) {
    return Padding(
      ...
      child: Container(
        ...
        child: Stack(
          children: <Widget>[
            //  new SvgPicture.asset('assets/images/Rectangle.svg'),
  ...
  Widget CompatibleAmour(context) {
    return Padding(
      padding: const EdgeInsets.only(right: 16, left: 16, top: 10, bottom: 20),
      child: Stack(
        children: [
          const Padding(
  ...
  Widget TopVoyants(context) {
    return Padding(
      padding: const EdgeInsets.only(right: 16, left: 0, top: 0, bottom: 5),
      child: Container(
          width: 380,
          height: 250,
          child: Column(
            children: [
              Padding(
                padding: const EdgeInsets.only(
                    right: 190, left: 0, top: 10, bottom: 10),
                child: Text(
                  "Top Voyants",
                  style: GoogleFonts.poppins(
                    color: Colors.white.withOpacity(0.9),
...
//Widget Story -----------------------------
  Widget StoryAstro(context) {
    return Padding(
      padding: const EdgeInsets.only(right: 0, left: 0, top: 25, bottom: 20),
      child: Container(
        width: 380,
        height: 140,
        child: Column(
          children: [
            Padding(
              padding: const EdgeInsets.only(
                  right: 160, left: 0, top: 10, bottom: 10),
              child: Text(
